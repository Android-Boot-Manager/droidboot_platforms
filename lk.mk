...
MODULE_SRCS += $(DROIDBOOT_PLATFORM_LOCAL_PATH)/common/droidboot_platform_common.c $(DROIDBOOT_PLATFORM_LOCAL_PATH)/libc-hack/lk/stroq.c $(DROIDBOOT_PLATFORM_LOCAL_PATH)/libc-hack/lk/strtouq.c $(DROIDBOOT_PLATFORM_LOCAL_PATH)/libc-hack/lk/sscanf.c
endif
