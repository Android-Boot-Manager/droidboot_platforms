...
uint32_t droidboot_internal_get_kernel_load_addr(void);
uint32_t droidboot_internal_get_ramdisk_load_addr(void);
uint32_t droidboot_internal_get_dtb_load_addr(void);
